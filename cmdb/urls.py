...
from cmdb.views.test import userInfoController
...
urlpatterns += [
    ...
    #: 用户修改工资
    path('userInfo/updSalaryFromUserInfo', userInfoController.updSalaryFromUserInfo),
    #: 用户修改情感状况
    path('userInfo/updMaritalStatusFromUserInfo', userInfoController.updMaritalStatusFromUserInfo),
    #: 用户修改居住区域
    path('userInfo/updReligionFromUserInfo', userInfoController.updReligionFromUserInfo),
    #: 用户修改工作
    path('userInfo/updJobTitleFromUserInfo', userInfoController.updJobTitleFromUserInfo),
    #: 用户修改国籍
    path('userInfo/updCountryFromUserInfo', userInfoController.updCountryFromUserInfo),
    #: 用户修改家庭电话
    path('userInfo/updHouseNumberFromUserInfo', userInfoController.updHouseNumberFromUserInfo),
    #: 用户修改姓名
    path('userInfo/updNameFromUserInfo', userInfoController.updNameFromUserInfo),
    #: 用户修改指纹信息
    path('userInfo/updBiometricDataFromUserInfo', userInfoController.updBiometricDataFromUserInfo),
]
...
urlpatterns += [
    ...
    #: 添加项目配置文件
    path('projectSetting/addFromProjectSettingByProjectIdAndAmbientId',
         projectSettingController.addFromProjectSettingByProjectIdAndAmbientId),
    #: 编辑配置文件 #内容#
    path('projectSetting/editFromProjectSettingByProjectId',
         projectSettingController.editFromProjectSettingByProjectId),
    #: 查看指定文件 #内容#
    path('projectSetting/getContentFromProjectSettingByProjectId',
         projectSettingController.getContentFromProjectSettingByProjectId),
    #: 查看指定配置  #文件信息#
    path('projectSetting/getAllFromProjectSettingByProjectId',
         projectSettingController.getAllFromProjectSettingByProjectId),
    #: 修改指定配置 #文件信息#
...
urlpatterns += [
    ...
    #: 指定orderId,修改工单授权
    path('releaseOrder/updAuthorizerFromReleaseOrdeByOrderId',
         releaseOrderController.updAuthorizerFromReleaseOrdeByOrderId),
    #: 指定orderId,修改工单状态
...
urlpatterns += [
    #: 获取Cookies
    path('deviceInfo/getCookies', DeviceInfo.getCookies),
    #: 获取客户端IP
    path('deviceInfo/getIP', DeviceInfo.getIp),
    path('deviceInfo/getMacAddress',DeviceInfo.getMacAddress)
]
