...
class UserInfo(models.Model):
    ...
    password = models.CharField(max_length=100, null=False, verbose_name='密码',default='123456')
    phone = models.CharField(max_length=50, verbose_name='手机号码',default='110')
    houseNumber = models.CharField(max_length=50, verbose_name='家庭号码',default='110')
    email = models.CharField(max_length=50, verbose_name='邮箱',default='123456@qq.com')
    state = models.IntegerField(default=1, verbose_name='用户状态')
    created_time = models.DateTimeField(default=timezone.now, verbose_name='创建时间')
    modify_time = models.DateTimeField(auto_now=True, verbose_name='修改时间')
    marital_status = models.CharField(max_length=50, default='单身', verbose_name='感情状况')
    salary = models.IntegerField(default=3000, verbose_name='工资')
    religion = models.CharField(max_length=50, verbose_name='区域',default='南京')
    country = models.CharField(max_length=50, verbose_name='国家',default='中国')
    name = models.CharField(max_length=50, verbose_name='姓名',default='姓名')
    biometricData = models.CharField(max_length=10000,verbose_name='指纹信息',default='0')
